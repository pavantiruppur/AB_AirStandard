...
public class Components {
	...
	static Font DIGITAL_ITALIC_FONT = null;
	static Font DIGITAL_MONOITALIC_FONT = null;
	static Font DIGITAL_MONO_FONT = null;
	static Font DIGITAL_FONT = null;
	static {
		try {
			DIGITAL_FONT = Font.createFont(Font.TRUETYPE_FONT, Components.class.getClassLoader().getResourceAsStream("resources/fonts/digital_7/digital-7.ttf"));
			ge.registerFont(DIGITAL_FONT);
			DIGITAL_ITALIC_FONT = Font.createFont(Font.TRUETYPE_FONT, Components.class.getClassLoader().getResourceAsStream("resources/fonts/digital_7/digital-7 (italic).ttf"));
			ge.registerFont(DIGITAL_ITALIC_FONT);
			DIGITAL_MONOITALIC_FONT = Font.createFont(Font.TRUETYPE_FONT, Components.class.getClassLoader().getResourceAsStream("resources/fonts/digital_7/digital-7 (mono italic).ttf"));
			ge.registerFont(DIGITAL_MONOITALIC_FONT);
			DIGITAL_MONO_FONT = Font.createFont(Font.TRUETYPE_FONT, Components.class.getClassLoader().getResourceAsStream("resources/fonts/digital_7/digital-7 (mono).ttf"));
			ge.registerFont(DIGITAL_MONO_FONT);
...
//		panel.setBorder(BorderFactory.createLineBorder(Color.black));
	...
	public static Font getDPMediumFont(float size) {
		return DIGITAL_ITALIC_FONT.deriveFont(size);
	}
	
	public static Font getDigital(float size) {
		return DIGITAL_ITALIC_FONT.deriveFont(size);
	}
